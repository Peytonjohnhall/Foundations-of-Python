...
It is quicker because it does not use functions but arguably sloppier.
"""
...
score = []
# copied and pasted from Assignment2.py
while True:
    percentage = float(input("Enter exam scores one at a time. Once you are do"
    						 "ne, enter \"-1\": "))
    if percentage == -1:
        break
